...
<ul id="dropdown2" class="dropdown-content blue-grey darken-1">
  <li><a href="javascript:void(0)">{!! Auth::candidate()->get()->first_name !!}</a></li>
  <li class="divider"></li>
  <li><a href="{!! URL::route('candidate.logout') !!}"><i class="fa fa-sign-out fa-fw"></i> LOGOUT</a>
</ul>
	    ...
	    <div class="nav-wrapper blue-grey darken-1">
	      <a href="#!" class="brand-logo" style="padding-left:10px;">NEE Portal {!! $year=Date('Y') !!}</a>
	      	...
	      	<ul class="right hide-on-med-and-down">
	        	...
	        	<li><a class="dropdown-button" href="javascript:void(0)" data-activates="dropdown1">
              &nbsp; {!! Auth::candidate()->get()->first_name !!} &nbsp;
