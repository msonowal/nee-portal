  ...
  <div class="col-sm-12">
	<div class="box">
		<div class="box-header">
			...
			{!! Form::open(array('route'=>'admin.search.transaction_failed', 'id' => 'applicant_search_form', 'class'=>'form-horizontal')) !!}
				 <?php $type = [''=>'--Select--', 'email' =>'Email', 'form_no' => 'Form No', 'mobile_no' => 'Mobile No', 'order_info' => 'Order No', 'name' => 'Candidate Name'];
