	...
	<div class="block-7">
		...
		<table class="table-3" cellspacing="0" cellpadding="3">
		  ...
		  <td width="140" rowspan="3" align="center" valign="middle"> {!! Html::image($step3->getSignature(), '', array('height' => '40px','width' => '140px')) !!} Candidate's Signature</td>
			...
			<tr>
			  <td height="92" colspan="2" align="center" valign="top"><img src="{{ asset('images/ms2016.jpg') }}" class="image-ms"><br/>
...
time of admission.<br/>
	   12. The selected/wait listed candidates may bring an affidavit in case of mistakes in candidate's personal details, i.e., spelling mistake in name of candidate/father/guardian and address at the time of counselling.<br/> 
