...
class ExamDetailSeeder extends Seeder
{
    ...
    {
    	  //NEE I
        ExamDetail::create(['eligible_for' =>'Base Module of Engineering & Technology']);
        //ExamDetail::create(['exam_id' =>'1', 'eligible_for' =>'Base Module of Engineering & Technology']);
        //NEE II
        ExamDetail::create(['eligible_for' =>'Diploma Module of Engineering & Technology']);
        ...
        ExamDetail::create(['eligible_for' =>'Degree Module of Forestry']);
        //ExamDetail::create(['exam_id' =>'2', 'eligible_for' =>'Degree Module of Forestry']);

        //NEE III
        ExamDetail::create(['eligible_for' =>'Degree Module in Engineering & Technology']);
