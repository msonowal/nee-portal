...
@section('page_heading','&emsp;NEE II(PCM_VOC) Selected')
@section('section')
  <div class="col-sm-12">
	<div class="box">
		<div class="box-header">
			<div class="form-group col-sm-3">
			{!! Form::open(array('route'=>'admin.search.neeii_pcm_voc_selected', 'id' => 'applicant_search_form', 'class'=>'form-horizontal')) !!}
