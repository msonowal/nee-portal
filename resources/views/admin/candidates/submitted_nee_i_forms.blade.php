  ...
  <div class="col-sm-12">
	...
	<div class="box">
		<div class="box-header">
			...
			{!! Form::open(array('route'=>'admin.search.nee_i', 'id' => 'applicant_search_form', 'class'=>'form-horizontal')) !!}
			...
			<div class="form-group col-sm-3">
				<a href="{{ route('genrate.report.nee_i') }}" class="btn btn-info"><i class="fa fa-file-text-o"></i> Generate Report</a>
			</div>
			{!! Form::close() !!}
		</div>
