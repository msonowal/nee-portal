...
@section('page_heading','&emsp;NEE II Forestry Selected')
@section('section')
  <div class="col-sm-12">
	<div class="box">
		<div class="box-header">
			<div class="form-group col-sm-3">
			{!! Form::open(array('route'=>'admin.search.neeii_pcb_selected', 'id' => 'applicant_search_form', 'class'=>'form-horizontal')) !!}
